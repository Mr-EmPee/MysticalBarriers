package ml.empee.mysticalbarriers.model.adapters;
...
public final class MultiBlockPacket {
  ...
  private MultiBlockPacket(
    int packetChunkX, int packetChunkY, int packetChunkZ, boolean suppressLightUpdates
  ) {
